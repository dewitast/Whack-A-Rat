...
public class HamsterTest {
  ...
  public void testGetSpeed() {
    assertEquals("getSpeed Error!", 50, c.getSpeed());
  }
  ...
  public void testChangeSpeed() {
    c.changeSpeed(3);
    assertEquals("decreaseHP Error!", 53, c.getSpeed());
  }
