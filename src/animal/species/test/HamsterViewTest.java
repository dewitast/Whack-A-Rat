 ...
 *
 */
public class HamsterViewTest {
  HamsterView hv = new HamsterView();
  /**
   * Test method for {@link animal.species.HamsterView#HamsterView()}.
   */
  @Test
  public void testHamsterView() {
    ...
    try {
      ...
      viewImage1.getGraphics().drawImage(hv.getImage1(), 0, 0, null);
      
      Image originalImage2 = ImageIO.read(new File("img/hamsterkanan2.png")); 
      ...
      viewImage2.getGraphics().drawImage(hv.getImage2(), 0, 0, null);
