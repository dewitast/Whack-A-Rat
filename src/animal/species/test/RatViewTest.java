 ...
 *
 */
public class RatViewTest {
  RatView rv = new RatView();
  /**
   * Test method for {@link animal.species.RatView#RatView()}.
   */
  @Test
  public void testRatView() {
    ...
    try {
      ...
      viewImage1.getGraphics().drawImage(rv.getImage1(), 0, 0, null);
      
      Image originalImage2 = ImageIO.read(new File("img/tikuskanan2.png")); 
      ...
      viewImage2.getGraphics().drawImage(rv.getImage2(), 0, 0, null);
