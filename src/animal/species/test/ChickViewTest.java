 ...
 *
 */
public class ChickViewTest {
  ChickView cv = new ChickView();
  /**
   * Test method for {@link animal.species.ChickView#ChickView()}.
   */
  @Test
  public void testChickView() {
    try {
      ...
      Image originalImage2 = ImageIO.read(new File("img/bebekkanan2.png")); 
